class ParseTools:
    ...
    @classmethod
    def parse_request(cls, request: str) -> str:
        parsed = {}  # dict with parsed values of request

        content: [str] = request.split('\r\n\r\n')    # seperation of request/headers and body
    ...
    @classmethod
    def write_response(cls, status_code: str, status_message: int, headers, body: str = '', http_version: str = 'HTTP/1.1') -> str:
